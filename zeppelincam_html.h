...
<style>
    @media screen and (max-width: 600px) {
        button, #container, figure, .slider-color, img {
            max-width: 100%;
            width: 100%;
        }
        #container{
...
<br>
<button id="ccwrbtn" onmousedown="send_elem_slow(3+':'+'0,1',0,this);" onmouseup="send_elem_slow(3+':'+'0,0',0,this);">Rotate CCW</button>
<button id="cwrbtn" onmousedown="send_elem_slow(3+':'+'1,0',0,this);" onmouseup="send_elem_slow(3+':'+'0,0',0,this);">Rotate CW</button>
<button id='vidbuttonon' onclick="send_elem_slow(4+':'+'1',0,this);">Enable Video</button>
<button id='vidbuttonoff' onclick="send_elem_slow(4+':'+'0',0,this);">Disable Video</button>
<br>
</div>
<br>
<div>
